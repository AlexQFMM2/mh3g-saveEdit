    ...
    : QEquipment(NULL, parent), m_platform(platform), m_characterSex(characterSex)
{
    ...
    layout->addWidget(new QLabel(uiText("Blue Component"), this), 0, 2);
    layout->addWidget(new QLabel(uiText("Green Component"), this), 0, 3);
    layout->addWidget(new QLabel(uiText("Red Component"), this), 0, 4);
    layout->addWidget(new QLabel(uiText("First Jewel's Identifier"), this), 0, 5);
    layout->addWidget(new QLabel(uiText("Second Jewel's Identifier"), this), 0, 6);
    layout->addWidget(new QLabel(uiText("Third Jewel's Identifier"), this), 0, 7);
    layout->addWidget(m_equipmentType, 1, 0);
    layout->addWidget(m_identifier, 1, 1);
    layout->addWidget(m_blueComponent, 1, 2);
    layout->addWidget(m_greenComponent, 1, 3);
    layout->addWidget(m_redComponent, 1, 4);
    layout->addWidget(m_firstJewelIdentifier, 1, 5);
    layout->addWidget(m_secondJewelIdentifier, 1, 6);
    layout->addWidget(m_thirdJewelIdentifier, 1, 7);
    ...
    layout->addWidget(m_validityLabel, 2, 0, 1, 8);
    layout->addWidget(buttons, 3, 0, 1, 8);
